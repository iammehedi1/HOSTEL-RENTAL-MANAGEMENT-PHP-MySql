...
<div class="container text-center">    
  <h1>Welcome To <font color="#a6e22b;"><b>ALIKE HOME</b></font></h1>
  <h1> Book a perfect Hostel near you ! </h1>
  <hr style="width: 700px;"><br><br><br>
  <div class="row">
    <div class="hov">
	...
	<div class="col-sm-4">
      ...
      <p class="text-justify"><?php echo substr($r_res['details'],0,100); ?></p><br>
	    <a href="#" class="btn btn-danger text-center"> VIEW DETAILS</a><br><br>
    </div>
	<?php } ?>
  </div>
  </div>
